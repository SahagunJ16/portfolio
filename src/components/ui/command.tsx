...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        {/*
          The header lives inside the portalled content so the visually hidden
          title/description are only in the accessibility tree while the dialog
          is open, instead of leaking a stray heading into the page outline.
        */}
